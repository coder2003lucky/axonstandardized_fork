...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 K_Tst /global/cscratch1/sd/zladd/axonstandardized/playground/genetic_alg/make_models_mappings/bbp_RmpRiTau_pipeline/genetic_alg/x86_64/K_Tst.mod\n");
