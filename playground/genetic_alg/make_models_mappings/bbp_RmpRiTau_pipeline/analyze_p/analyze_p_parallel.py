...
params_file_path = '../run_volts_bbp_calcium/params/params_bbp_calcium_ca_k_na_1000.hdf5'
...
if COMM.rank == 0:
	...
	opt_result_hdf5 = h5py.File(optimization_results_path+'opt_result_single_stim_bbp_calcium_ca_k_na.hdf5', 'w')
