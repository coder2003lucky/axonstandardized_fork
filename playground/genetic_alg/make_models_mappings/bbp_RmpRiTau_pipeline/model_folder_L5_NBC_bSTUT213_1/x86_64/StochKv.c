...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "area");
 	...
 	ivoc_help("help ?1 StochKv /global/cscratch1/sd/zladd/axonstandardized/playground/genetic_alg/make_models_mappings/bbp_RmpRiTau_pipeline/model_folder_L5_NBC_bSTUT213_1/x86_64/StochKv.mod\n");
