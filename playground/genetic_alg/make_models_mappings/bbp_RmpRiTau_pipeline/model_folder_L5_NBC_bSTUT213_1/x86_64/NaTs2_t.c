...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 NaTs2_t /global/cscratch1/sd/zladd/axonstandardized/playground/genetic_alg/make_models_mappings/bbp_RmpRiTau_pipeline/model_folder_L5_NBC_bSTUT213_1/x86_64/NaTs2_t.mod\n");
