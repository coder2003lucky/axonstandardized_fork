...
params_file_name = '../run_volts_bbp_calcium/params/params_bbp_calcium_ca_k_na_5000.hdf5'
volts_path = '../volts/'
output_path = '../scores/'
...
#num_volts_to_run = 1
#i=int(sys.argv[1])
volts_name_list = volts_name_list[365:] #volts_name_list[(i-1)*num_volts_to_run:(i)*num_volts_to_run]
...
score_functions = custom_score_functions + efel_score_functions_1 + efel_score_functions_2
