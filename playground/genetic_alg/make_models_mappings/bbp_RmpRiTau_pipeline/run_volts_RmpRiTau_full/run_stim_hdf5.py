...
params_file_path = './params/params_bbp_full_5.hdf5'
full_stims_file_path = './stims/stims_full_RmpRiTau.hdf5'
neg_stims_file_path = './stims/neg_stims_RmpRiTau.hdf5'
...
full_stims_hdf5 = h5py.File(full_stims_file_path, 'r')
neg_stims_hdf5 = h5py.File(neg_stims_file_path, 'r')
params_hdf5 = h5py.File(params_file_path, 'r')
params_name_list = list(params_hdf5.keys())
full_stim_names = list(full_stims_hdf5.keys())
neg_stim_names = list(neg_stims_hdf5.keys())
stims_name_list = sorted(full_stim_names+neg_stim_names)
...
def run_model(run_file, param_set, stim_name, ntimestep):
	...
	if stim_name in full_stim_names:
		stim_data = full_stims_hdf5[stim_name]
	else:
		stim_data = neg_stims_hdf5[stim_name]
