...
## set up filepaths
paramsCSV = '../params/params_bbp_RmpRiTau_full.csv'
...
stims_path = '../stims/stims_full_RmpRiTau.hdf5'
...
def prepare_data():
    ...
    for i in range(len(opt_stim_name_list)):
        ...
        if stim not in list(stim_file.keys()):
            continue
...
def main():
    ...
    run_model(0,0)
    data = nrnMread("/tmp/Data/VHotP0.dat")
    print(data)
    print(np.max(data))
