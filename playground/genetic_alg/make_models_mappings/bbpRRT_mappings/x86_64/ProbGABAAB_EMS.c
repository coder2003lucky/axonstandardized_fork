...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 ProbGABAAB_EMS /global/cscratch1/sd/zladd/axonstandardized/playground/genetic_alg/make_models_mappings/bbpRRT_mappings/x86_64/ProbGABAAB_EMS.mod\n");
