// Automatically generated CU for /global/cscratch1/sd/zladd/axonstandardized/playground/genetic_alg/make_models_mappings/bbpRRT_mappings./runModel.hoc
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
__device__ void Custates_StochKv(MYFTYPE v,MYFTYPE gamma_StochKv,MYFTYPE gkbar_StochKv,MYFTYPE tha_StochKv,MYFTYPE qa_StochKv,MYFTYPE Ra_StochKv,MYFTYPE Rb_StochKv,MYFTYPE deterministic_StochKv,MYFTYPE &*pv,MYFTYPE &void Cupv);
__device__ void Cutrates_StochKv(MYFTYPE v ,MYFTYPE gamma_StochKv,MYFTYPE gkbar_StochKv,MYFTYPE tha_StochKv,MYFTYPE qa_StochKv,MYFTYPE Ra_StochKv,MYFTYPE Rb_StochKv,MYFTYPE deterministic_StochKv,MYFTYPE &*pv,MYFTYPE &void Cupv);
__device__ void CuChkProb_StochKv(MYFTYPE p,MYFTYPE gamma_StochKv,MYFTYPE gkbar_StochKv,MYFTYPE tha_StochKv,MYFTYPE qa_StochKv,MYFTYPE Ra_StochKv,MYFTYPE Rb_StochKv,MYFTYPE deterministic_StochKv,MYFTYPE &*pv,MYFTYPE &void Cupv);
__device__ void CusetRNG_StochKv(,MYFTYPE gamma_StochKv,MYFTYPE gkbar_StochKv,MYFTYPE tha_StochKv,MYFTYPE qa_StochKv,MYFTYPE Ra_StochKv,MYFTYPE Rb_StochKv,MYFTYPE deterministic_StochKv,MYFTYPE &*pv,MYFTYPE &void Cupv);
...
// Functions:
__device__ MYFTYPE CuSigmoidRate_StochKv(MYFTYPE v ,MYFTYPE th ,MYFTYPE a (1/ms){
UNITSOFF;
if (fabs(v-th) > 1e-6 ) {;
...
__device__ MYFTYPE Custrap_StochKv(MYFTYPE x){
if (x < 0) {;
return  0;
VERBATIM;
...
__device__ MYFTYPE Cuurand_StochKv(MYFTYPE ){
VERBATIM;
/*;
;
;
...
__device__ MYFTYPE Cubrand_StochKv(MYFTYPE P,MYFTYPE  N){
VERBATIM;
/*;
;
;
...
__device__ MYFTYPE CuBnlDev _StochKv(MYFTYPE ppr,MYFTYPE  nnr){
VERBATIM;
int j;;
static int nold=(-1);;
...
__device__ void Custates_StochKv(MYFTYPE v,MYFTYPE gamma_StochKv,MYFTYPE gkbar_StochKv,MYFTYPE tha_StochKv,MYFTYPE qa_StochKv,MYFTYPE Ra_StochKv,MYFTYPE Rb_StochKv,MYFTYPE deterministic_StochKv,MYFTYPE &*pv,MYFTYPE &void Cupv) {
   Cutrates_StochKv (   v ,gamma_StochKv,gkbar_StochKv,tha_StochKv,qa_StochKv,Ra_StochKv,Rb_StochKv,deterministic_StochKv,a,b,ninf,ntau);
   P_a = Custrap_StochKv (   a * dt ) ;
   P_b = Custrap_StochKv (   b * dt ) ;
   CuChkProb_StochKv (   P_a ,gamma_StochKv,gkbar_StochKv,tha_StochKv,qa_StochKv,Ra_StochKv,Rb_StochKv,deterministic_StochKv);
   CuChkProb_StochKv (   P_b ,gamma_StochKv,gkbar_StochKv,tha_StochKv,qa_StochKv,Ra_StochKv,Rb_StochKv,deterministic_StochKv);
   n0_n1 = CuBnlDev _StochKv(   P_a , N0 ) ;
   n1_n0 = CuBnlDev _StochKv(   P_b , N1 ) ;
   N0 = Custrap_StochKv (   N0 - n0_n1 + n1_n0 ) ;
   N1 = N - N0 ;
}
__device__ void Cutrates_StochKv(MYFTYPE v ,MYFTYPE gamma_StochKv,MYFTYPE gkbar_StochKv,MYFTYPE tha_StochKv,MYFTYPE qa_StochKv,MYFTYPE Ra_StochKv,MYFTYPE Rb_StochKv,MYFTYPE deterministic_StochKv,MYFTYPE &*pv,MYFTYPE &void Cupv) {
   tadj_StochKv = powf( q10_StochKv , ( ( celsius - temp_StochKv ) / ( 10.0 ) ) ) ;
   a = CuSigmoidRate_StochKv (   v , tha_StochKv , Ra_StochKv , qa_StochKv ) ;
   a = a * tadj_StochKv ;
   b = CuSigmoidRate_StochKv (   - v , - tha_StochKv , Rb_StochKv , qa_StochKv ) ;
   b = b * tadj_StochKv ;
   ntau = 1.0 / ( a + b ) ;
   ninf = a * ntau ;
}
...
//    fprintf(stderr, "StochKv.mod:CuChkProb_StochKv: argument not a probability.\n",gamma_StochKv,gkbar_StochKv,tha_StochKv,qa_StochKv,Ra_StochKv,Rb_StochKv,deterministic_StochKv);
 }
}
__device__ void CusetRNG_StochKv(,MYFTYPE gamma_StochKv,MYFTYPE gkbar_StochKv,MYFTYPE tha_StochKv,MYFTYPE qa_StochKv,MYFTYPE Ra_StochKv,MYFTYPE Rb_StochKv,MYFTYPE deterministic_StochKv,MYFTYPE &*pv,MYFTYPE &void Cupv) {
...
__device__ void CuInitModel_StochKv(MYFTYPE v,MYFTYPE &n,MYFTYPE &N0,MYFTYPE &n0_n1,MYFTYPE gamma_StochKv,MYFTYPE gkbar_StochKv,MYFTYPE tha_StochKv,MYFTYPE qa_StochKv,MYFTYPE Ra_StochKv,MYFTYPE Rb_StochKv,MYFTYPE deterministic_StochKv){
MYFTYPE *pv,void** pv;
    eta = gkbar_StochKv / gamma_StochKv;
Cutrates_StochKv(v,gamma_StochKv,gkbar_StochKv,tha_StochKv,qa_StochKv,Ra_StochKv,Rb_StochKv,deterministic_StochKv,*pv,void** pv);
    n = ninf;
...
__device__ void CuBreakpointModel_StochKv(MYSECONDFTYPE &sumCurrents, MYFTYPE &sumConductivity, MYFTYPE v,MYFTYPE &n,MYFTYPE &N0,MYFTYPE &n0_n1,MYFTYPE gamma_StochKv,MYFTYPE gkbar_StochKv,MYFTYPE tha_StochKv,MYFTYPE qa_StochKv,MYFTYPE Ra_StochKv,MYFTYPE Rb_StochKv,MYFTYPE deterministic_StochKv) {
MYFTYPE ik, gk, eta;
MYFTYPE ;
   gk = ( Custrap_StochKv (   N1 ,gamma_StochKv,gkbar_StochKv,tha_StochKv,qa_StochKv,Ra_StochKv,Rb_StochKv,deterministic_StochKv) * scale_dens * tadj_StochKv ) ;
   ik = 1e-4 * gk * ( v - ek ) ;
sumCurrents+= ik;
sumConductivity+= gk;
};
