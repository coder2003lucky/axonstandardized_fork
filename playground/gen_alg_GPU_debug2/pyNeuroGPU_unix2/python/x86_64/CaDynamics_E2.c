...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaDynamics_E2 /global/cscratch1/sd/zladd/axonstandardized/playground/gen_alg_GPU_debug2/pyNeuroGPU_unix2/python/x86_64/CaDynamics_E2.mod\n");
