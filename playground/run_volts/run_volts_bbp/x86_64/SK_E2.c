...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 SK_E2 /global/cscratch1/sd/zladd/axonstandardized/playground/run_volts/run_volts_bbp/SK_E2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/global/cscratch1/sd/zladd/axonstandardized/playground/run_volts/run_volts_bbp/SK_E2.mod";
static const char* nmodl_file_text = 
