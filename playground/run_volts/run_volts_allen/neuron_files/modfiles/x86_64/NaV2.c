...
#define nrn_init _nrn_init__NaV2
#define _nrn_initial _nrn_initial__NaV2
#define nrn_cur _nrn_cur__NaV2
#define _nrn_current _nrn_current__NaV2
#define nrn_jacob _nrn_jacob__NaV2
#define nrn_state _nrn_state__NaV2
#define _net_receive _net_receive__NaV2 
#define activation activation__NaV2 
#define rates rates__NaV2 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_NaV2", _hoc_setdata,
 "rates_NaV2", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define Coff Coff_NaV2
 double Coff = 2;
#define Con Con_NaV2
 double Con = 0.01;
#define Ooff Ooff_NaV2
 double Ooff = 0.05;
#define Oon Oon_NaV2
 double Oon = 8;
#define alfac alfac_NaV2
 double alfac = 2.51;
#define alpha alpha_NaV2
 double alpha = 400;
#define btfac btfac_NaV2
 double btfac = 5.32;
#define beta beta_NaV2
 double beta = 12;
#define delta delta_NaV2
 double delta = 60;
#define gamma gamma_NaV2
 double gamma = 250;
#define rateadj rateadj_NaV2
 double rateadj = 1;
#define x2 x2_NaV2
 double x2 = -24;
#define x1 x1_NaV2
 ...
 "Oon_NaV2", &Oon_NaV2,
 "Ooff_NaV2", &Ooff_NaV2,
 "alpha_NaV2", &alpha_NaV2,
 "beta_NaV2", &beta_NaV2,
 "gamma_NaV2", &gamma_NaV2,
 "delta_NaV2", &delta_NaV2,
 "alfac_NaV2", &alfac_NaV2,
 "btfac_NaV2", &btfac_NaV2,
 "x1_NaV2", &x1_NaV2,
 "x2_NaV2", &x2_NaV2,
 "rateadj_NaV2", &rateadj_NaV2,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 NaV2 /global/cscratch1/sd/zladd/axonstandardized/playground/run_volts/run_volts_allen/neuron_files/modfiles/NaV2.mod\n");
...
static int  rates (  double _lv ) {
   double _lqt ;
 _lqt = pow( 2.3 , ( ( celsius - 37.0 ) / 10.0 ) ) * rateadj ;
 ...
 t = 0.0;
{
 ...
 if(error){fprintf(stderr,"at line 105 in file NaV2.mod:\n SOLVE seqinitial\n"); nrn_complain(_p); abort_run(error);}
 }
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 98 in file NaV2.mod:\n	SOLVE activation METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 12; ++_i) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/global/cscratch1/sd/zladd/axonstandardized/playground/run_volts/run_volts_allen/neuron_files/modfiles/NaV2.mod";
static const char* nmodl_file_text = 
