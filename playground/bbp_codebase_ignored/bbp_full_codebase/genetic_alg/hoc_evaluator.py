...
paramsCSV = '../make_paramset_hdf5/params_reference/params_bbp_full.csv'
orig_params = h5py.File(run_volts_path+'params/params_bbp_full.hdf5', 'r')['orig_full'][0]
scores_path = '../scores/'
objectives_file = h5py.File('./objectives/multi_stim_bbp_full_20_stims.hdf5', 'r')
