...
def save_stims(model_number, passive, show=False, pdf=None, force=False):
...
if __name__ == "__main__":
    ...
    save_stims(args.model, passive=args.passive, force=args.force, show=True, pdf=pdf)
