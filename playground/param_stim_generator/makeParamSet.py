...
orig = param_df['Base value'].values.reshape(1,-1)

print(param_df[['Param name', 'Base value', 'Lower bound', 'Upper bound']])

pSortedMatx = helper.test(param_df, nSubZones, nPerSubZone, params, norm, seed)
