...
run_dir = 'pyNeuroGPU_unix2/'
unix_dir = 'pyNeuroGPU_unix2/'
data_dir = './Data/'
split_flg = 0
baseDir = ''
has_f = 0
...
# TRY NEW MODEL FILE
#modelFile = "./runModelAllen.hoc"

#modelFile = "./run_model_cori.hoc"
...
def write_stim(rec_sites,seg_start,seg_end):
    ...
    stim_meta_dict['Nt'] = 10000#len(times)
    ...
    nrn.h("access root.sec")
    #print(st_area, "<------- STAREA", nrn.h.stLoc, "<------- SAINT LOC")
...
def run_extract(to_map):
    ...
    ### monkey patching
    readparam_set = np.genfromtxt(param_set, delimiter=",")
    nrn.h.transvec = nrn.h.Vector(len(readparam_set), 1).from_python(readparam_set)
